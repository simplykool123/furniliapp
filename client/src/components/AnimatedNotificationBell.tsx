    ...
    <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-80 max-h-96 overflow-y-auto">
          ...
          <div className="px-4 py-3 border-b">
            <span className="font-semibold text-xl sm:text-lg text-gray-900">Notifications</span>
          </div>
            ...
            <>
              ...
              >
                ...
                <div className="flex-1">
                  <div className="font-medium text-lg sm:text-base text-gray-900">
                    {lowStockCount} products need restocking
                  </div>
                  <div className="text-base sm:text-sm text-gray-500">Low stock alerts</div>
                </div>
              </DropdownMenuItem>
              <DropdownMenuSeparator />
            </>
            ...
            <>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-base sm:text-sm text-gray-500">Material requests</div>
                </div>
              </DropdownMenuItem>
              <DropdownMenuSeparator />
            </>
              ...
              {tasks.slice(0, 3).map((task) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-medium text-lg sm:text-base text-gray-900 truncate">
                      {task.title}
                    </div>

...
const conferenceTableProducts = [
  ...
  },
  {
    ...
    size: "1200-3600mm L x 1200mm W x 750mm H", 
    tax_rate: 18,
    image_url: "https://images.unsplash.com/photo-1556761175-b413da4baf72?w=800&h=600&fit=crop&crop=center"
  },
  {
    ...
    size: "1200-3600mm L x 1200mm W x 750mm H",
    tax_rate: 18,
    image_url: "https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=800&h=600&fit=crop&crop=center"
  },
  {
    ...
    size: "1200-3600mm L x 1200mm W x 750mm H",
    tax_rate: 18,
    image_url: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=800&h=600&fit=crop&crop=center"
  },
  {
    ...
    size: "1200-3600mm L x 1200mm W x 750mm H",
    tax_rate: 18,
    image_url: "https://images.unsplash.com/photo-1564069114553-7215e1ff1890?w=800&h=600&fit=crop&crop=center"
  },
  {
    ...
    size: "1200-3600mm L x 1200mm W x 750mm H",
    tax_rate: 18,
    image_url: "https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=800&h=600&fit=crop&crop=center"
  },
  ...
  // Round Meeting Tables
  {
    ...
    tax_rate: 18,
    image_url: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=800&h=600&fit=crop&crop=center"
  },
  {
    ...
    size: "900-1200mm D x 750mm H",
    tax_rate: 18,
    image_url: "https://images.unsplash.com/photo-1582653291997-079a1c04e5a1?w=800&h=600&fit=crop&crop=center"
  },
  {
...
export async function addConferenceTableProducts() {
  try {
    ...
    for (const product of conferenceTableProducts) {
      ...
      console.log(`✅ Added: ${inserted.name} - ₹${inserted.price.toLocaleString()}`);
    }
    
    console.log(`\n🎉 Successfully added ${conferenceTableProducts.length} conference table products!`);
    console.log(`📊 Price range: ₹${Math.min(...conferenceTableProducts.map(p => p.price)).toLocaleString()} - ₹${Math.max(...conferenceTableProducts.map(p => p.price)).toLocaleString()}`);
